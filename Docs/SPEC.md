...
- ~~**5.25" DD geometry**~~ — **answered 2026-08-31.** [FAQ §3] documents only 3.5" DD and HD, but the A1020 is a 40-track drive giving 440 KB through `trackdisk.device`, which is `40 × 2 × 11 × 512 = 450,560` bytes. See §5.25-inch disks, which also records that no oracle can check it.
