...
4. **Phase 2 in progress.** Done: links (BUG-005), HD and extra-cylinder geometry, bitmap rebuild, unpartitioned hardfiles (BUG-006), **RDB partitioning** and **dircache** (both 2026-08-24). Left: LNFS, 5.25" DD (no source), configurable block sizes (parsed and honoured, but nothing to test against — everything held is 512).
