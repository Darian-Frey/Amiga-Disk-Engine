...
- [ ] FILE_ID.DIZ surfacing. Rare here — 2 of 300 sampled disks — and already reachable with `ade extract`, since it is an ordinary file; what is missing is only surfacing it automatically.
